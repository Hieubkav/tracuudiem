...
import axios from 'axios';
  const consumer = {
    updateConfigSV: function (status) {
        const url = `/api/cau-hinh/${status}/update-config-allow-info-hssv`; /** Phong API */
        return axios.put(url).then(res => res.data);
    },
    getListLopHoc: function () {
        const url = '/api/lop-hoc/all';/** Phong API */
        return axios.get(url).then(response => response.data);
    },
    getLopHoc: function (lh_id) {
        const url = '/api/lop-hoc/' + lh_id;/** Phong API */
        return axios.get(url).then(response => response.data);
    },
    getKetQuaHocTap: function (lh_id, semester) {
      const url = `/api/nhap-diem/${lh_id}/ket-qua-hoc-tap/json?semester=${semester}`;/** Phong API */
    ...
    uploadFile: function (file, sheet) {
      ...
      return axios.post('/api/excel/import-score-check', formData, headers).then(res => res.data);/** Phong API */
    }
  }
