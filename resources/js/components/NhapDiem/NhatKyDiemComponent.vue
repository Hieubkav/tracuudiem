...
export default {
    ...
    methods: {
        ...
        clearboloc: function(){
            window.location.href = "/nhap-diem/nhat-ky";
        },
        ...
        nhapDiemUrl: function (nk) {
            ...
            /* return '/nhap-diem/xem-nhat-ky-diem?bd_id=' + nk.bang_diem.bd_id + '&thoigian="' + nk.thoigian + '"&mh_id=' +nk.mon_hoc.mh_id + '&lh_id=' + nk.lop_hoc.lh_id; */
            return '/nhap-diem/xem-nhat-ky-diem/' + encodeURIComponent(baseSixFour);
