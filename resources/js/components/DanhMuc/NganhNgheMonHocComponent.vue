        ...
        <section class="content">
            <div style="margin-bottom: 6px">
                ...
                <a v-bind:href="excel" class="btn btn-success btn-flat"
                    ><i class="fa fa-file-excel-o"></i> Thêm môn học bằng Excel</a
                >
                    ...
                    <div class="box box-widget">
                        <div class="box-body table-responsive">
                            ...
                            >
                                <thead>
                                    <tr>
                                        <th class="w-3 text-center">STT</th>
                                        <th>Mã</th>
                                        <th>Môn học</th>
                                        ...
                                        <!-- <th
                                            class="text-center w-90-p"
                                            v-if="!nganhNghe.khoa_dao_tao_exists"
                                        >
                                            Hành động
                                        </th> -->
                                        <th
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="listMonHoc.original == null || listMonHoc.original.length == 0">
                                        <td colspan="100" class="text-center">
                                            {{ listMonHoc.original != null ? "Không tìm thấy dữ liệu" : "Đang tải" }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
