                            ...
                            <table class="table table-hover table-striped table-bordered no-margin">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- <th class="w-1 text-center">Xóa</th> -->
                                    </tr>
                                </thead>
                                <!-- <draggable v-model="semester.monHoc" draggable=".drag-item" tag="tbody"> -->
                                <tbody>
                                    <tr v-for="(mh, semesterIndex) in editForm.listSemester" :key="semesterIndex" v-if="mh.pivot">
                                        ...
                                        <td>
                                            <input type="checkbox" :checked="mh.pivot['kdt_mh_apdung']" v-model="mh.pivot['kdt_mh_apdung']" />
                                        </td>
            ...
            consumer.getSyncMonHocTheoNganhNghe(requestData)
                .then(response => {
                    if (response.status == 200) {
                        ...
                        console.log(this.listMonHocSync);
